...
public enum ProfileImage {
    LEVEL_1(1, "프로필 이미지_1 이름 (미정)", "기본 스푼. 스푸니에 오신 걸 환영해요!", "profile1.png",0),
    LEVEL_2(2,"프로필 이미지_2 이름 (미정)", "내 리뷰가 다른 유저들의 지도에 10번 저장", "profile2.png",10),
    LEVEL_3(3, "프로필 이미지_3 이름 (미정)","내 리뷰가 다른 유저들의 지도에 30번 저장", "profile3.png",30),
    LEVEL_4(4, "프로필 이미지_4 이름 (미정)","내 리뷰가 다른 유저들의 지도에 50번 저장", "profile4.png",50),
    LEVEL_5(5,"프로필 이미지_5 이름 (미정)", "내 리뷰가 다른 유저들의 지도에 70번 저장", "profile5.png",70),
    LEVEL_6(6, "프로필 이미지_6 이름 (미정)","내 리뷰가 다른 유저들의 지도에 100번 저장", "profile6.png",100);
