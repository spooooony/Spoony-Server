...
public enum ProfileImage {
    LEVEL_1(1, "새싹푼이", "기본 스푼. 스푸니에 오신 걸 환영해요!", "profile1.png",0),
    LEVEL_2(2,"탐험푼이", "내 리뷰가 다른 유저들의 지도에 10번 저장", "profile2.png",10),
    LEVEL_3(3, "냠냠푼이","내 리뷰가 다른 유저들의 지도에 30번 저장", "profile3.png",30),
    LEVEL_4(4, "싹싹푼이", "내 리뷰가 다른 유저들의 지도에 50번 저장", "profile4.png",50),
    LEVEL_5(5,"천사푼이", "내 리뷰가 다른 유저들의 지도에 70번 저장", "profile5.png",70),
    LEVEL_6(6, "마스터푼이", "내 리뷰가 다른 유저들의 지도에 100번 저장", "profile6.png",100);
